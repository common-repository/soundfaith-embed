...
class SF_Embed_Admin {
	...
	public function add_plugin_page() {
		add_options_page(
			'Sermon Embed', // page_title
			'Sermon Embed', // menu_title
	...
	public function create_admin_page() {
		...
		<div class="wrap">
			<h2>Sermon Embed</h2>
			<p>Embed sermons, series, or profiles from Faithlife Sermons (formerly SoundFaith) in your WordPress posts and pages. <br />
			Just paste the URL of the sermon, series, or profile into the post editor and the player will be automagically embedded. <br />
	...
	public function page_init() {
		...
		register_setting(
			...
			add_settings_section(
				...
				'Profile/Series Embed Settings', // title
	...
	public function profile_section_info() {
		echo '<p>These settings will be applied when embedding profiles and series.</p>';
		echo '<p><em>Note: It is possible for a profile/series URL to change. Use the <code>groupId</code> in your URL to avoid issues.</em></p>';
	}
